...
public class HelloApplication extends Application {
    ...
    public BorderPane createMainLayout(){
        ...
        canvas = new CircuitCanvas(2000, 1500);
        ...
        sp.setStyle("-fx-background-color: white; -fx-effect: dropshadow(gaussian, rgba(0,0,0,0.08), 8, 0, 0, 2); -fx-background-radius: 12; -fx-border-radius: 12;");
